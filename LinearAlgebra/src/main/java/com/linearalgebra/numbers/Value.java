...
public class Value {
    ...
    public Value getInverse() {
        if (this.rationalValue != null) {
            ...
            Rational rationalValue = this.fromDouble(doubleValue);
    ...
    public boolean isZero() {
    	...
    	if (doubleValue!=null) {
    		...
    		double Value = (double) this.fromRational(rationalValue);
   ...
   public Value divide(Value other) {
    ...
    public double asDouble() {
    	if (this.doubleValue!= null) {
    		...
    		return this.fromRational(this.getRationalValue());
    	}
    	else {
            return 0.0;
        }
    ...
    public static Value parseValue(String value) {
    	...
    	if (parts.length < 1) {
    		Value a = new Value(Double.parseDouble(value));
    		return a;
    	}
            ...
            throw new RuntimeException("Error en el formato del valor: " + value);
        }
	 ...
	 */
	private Double fromRational(Rational value) {
	 ...
	 */
	private Rational fromDouble(double value) {
